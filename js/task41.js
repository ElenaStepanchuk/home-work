...
// Для исходного объекта после вызова метода atTheOldToad.removePotion("Dragon breath"), в свойстве potions
// будет массив[{ name: "Speed potion", price: 460 }, { name: "Stone skin", price: 520 }]

// Для исходного объекта после вызова метода atTheOldToad.removePotion("Speed potion"), в свойстве potions 
...
//   },
//   addPotion(newPotion) {
//     for (let namePotion of this.potions){
//           if (namePotion.name === newPotion.name) {
//       return `Error! Potion ${namePotion.name} is already in your inventory!`;
//     }
//     }
...
//     let potionsArray = [];
//     for (const total of this.potions){
//     potionsArray.push(total.name);
//     }
//     const potionIndex = potionsArray.indexOf(potionName);
